...
<div id="comentario">            
    <?php
        ...
        foreach($comentarios as $comentario){
            echo '<h2>'"Comentarios de" .$comentario['apartado.nombre']'</h2>''<br>''<p>'.$comentario['usuario.nombre'+ 'usuario.apellido' + 'comentario.texto' ].'</p>''<br>''<p id="fecha" style= font-family:"italic";
